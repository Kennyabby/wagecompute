                            ...
                            >
                                ...
                                <div className={'dets sldets'}>
                                    ...
                                    {approval && isApprover && <div className='deptdesc' style={{fontSize:'13px', color:'red'}}>{
                                        ...
                                        <div onClick={()=>{setShowReceiptsModal(true)}}><span style={{fontWeight: 'bold'}}>Void Receipt Reason:</span> Receipt "{approval.data?.voidReceipt.voidReceipt}"" already used on {approval.data?.voidReceipt.voidReceiptDate} in {approval.data?.voidReceipt.voidReceiptPoint.toUpperCase()}. <a>Click to View Receipt Report</a></div>
                                    }</div>}
                                </div>
