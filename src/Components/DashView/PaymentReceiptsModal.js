...
const PaymentReceiptsModal = ({ open, onClose, paymentReceipts }) => {
  ...
  return (
    <div className="modal-overlay" style={{position:'absolute',top:0,left:0,right:0,bottom:0,zIndex:1000,background:'rgba(0,0,0,0.25)'}}>
  <div className="modal-content" style={{background:'#fff',borderRadius:12,maxWidth:1200,width:'98%',margin:'40px auto',padding:32,boxShadow:'0 4px 32px rgba(0,0,0,0.12)',position:'relative'}}>
